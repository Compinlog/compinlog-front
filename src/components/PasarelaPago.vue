...
<main class ="main-container">
    <div class="container-pay-card">
        <section class="main-container_background">
            ...
            <div class="card"> 
            <img class="card_logo" style=" width: 55px; margin-bottom: 10px;" src="./images/card-logo.svg" alt="logo">
            <p class="card_numero" style="margin-bottom: 15px ;">0000 0000 0000 0000</p>

            <div class="card_details" style="display:flex; font-size: 0.9rem; justify-content: space-between; text-transform: uppercase;">
            ...
            <div class="card-back">
            <p class="card-back_code" style="font-size: 0.7rem; margin-top: 50px; text-align: right; padding-right: 10px;">000</p>
            </div>
        </section>
        ...
        <section class="main-container_form">
            <form class="form" action="">
                ...
                <input class="form_input" type="text" Nombre="cardnombre" id="cardnombre" placeholder="Nombre Propietario">
                <div class="form_caldholder_error errores"></div>

                <label class="form_label" for="cardNumber">Numero de Tarjeta</label>
                <input class="form_input" type="text" Nombre="cardNumber" id="cardNumber" maxlength="19" placeholder="0000 0000 0000 0000">
                <div class="form_input_numero_error errores"></div> 
                ...
                <div class="form_fecha-cvc">
                    ...
                    <input class="form_input" type="text" maxlength="2" Nombre="cardmes" id="cardmes" placeholder="MM">
                    <input class="form_input" type="text" maxlength="2" Nombre="cardaño" id="cardaño" placeholder="YY">
                    </div>
                    
                    <input class="form_input" type="text" maxlength="3" Nombre="carCvc" id="carCvc" placeholder="000">
                    
                    <div class="conteiner-error">
                    <div class="form_input_mm_error errores "></div>
                    <div class="form_input_yy_error errores"></div>
                    </div>
                    <div class="form_input_cvc_error errores "></div>
                </div>
